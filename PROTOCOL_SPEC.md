...
**Version:** 0.1.0-draft
**Status:** Source of truth for the protocol. Build phases and implementations must conform to this document. Changes here propagate everywhere; never edit an implementation to disagree with this spec — edit this spec and re-run downstream work.
...
Modules call `sz storage path <kind> [<namespace>]` to resolve.
