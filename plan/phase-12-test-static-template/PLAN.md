...
- Branch `phase-12-test-static-template`.

## Atomic steps

### Step 12.1 — Branch + dirs

```bash
git checkout main
git checkout -b phase-12-test-static-template
...
5. Branch `phase-12-test-static-template` has one commit.
